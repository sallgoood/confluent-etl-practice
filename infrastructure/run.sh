...
==============================================================================================================
1. datagen-pageviews produce messages to pageviews topic
2. mongo-sink consumes pageviews topic and write changes into mongoDb, test.pageviews
3. mongo-source polls and produce changes to mongo.test.pageviews

Examine the topics in the Kafka UI: http://localhost:9021 (control-center) or http://localhost:8000/ (kafka-topic-ui)
...
Examine the collections:
  ...
  - NodeJS nosqlclient, http://localhost:3000, mongodb://mongo1:27017,mongo2:27017,mongo3:27017/?replicaSet=rs0
==============================================================================================================
